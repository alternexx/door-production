...
export const dealTypes: Record<string, DealTypeConfig> = {
  ...
  applications: {
    ...
    stages: [
      ...
      "Approved/Change to In Contract",
      "Welcome Email Sent",
  ...
  "tenant-rep": {
    ...
    stages: [
      "Tenant Onboarding",
      "Tenant Rep Form Signed",
      "Gathering Documents",
      "Scheduling Showings",
      "Working on App",
      "Client Approved",
      "Client Closing/Create Invoice",
      "Not Responsive",
    ],
    fields: [
      { key: "client", label: "Client", type: "text", required: true },
